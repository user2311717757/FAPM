...
model_path = "/mnt/data1/nianke_catastrophic_forgetting/motivation/Qwen2_squad_sparsification_lora_0.9"
#/mnt/data1/model/meta-llama/Meta-Llama-3-8B-Instruct /mnt/data1/model/qwen/Qwen2-7B-Instruct
...
#/mnt/data1/nianke_catastrophic_forgetting/LLaMA-Factory-main/data_squad/squad_validation_qwen.json

with open("/mnt/data1/nianke_catastrophic_forgetting/LLaMA-Factory-main/data_squad/squad_validation_qwen.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
if len(result) != len(label_list):
    ...
    Accuracy = f1_score(label_list, result, average='weighted')
