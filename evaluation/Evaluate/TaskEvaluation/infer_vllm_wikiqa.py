...
model_path = "/mnt/data1/nianke_catastrophic_forgetting/motivation/Qwen2_wikiqa_sparsification_wise"
...
with open("/mnt/data1/nianke_catastrophic_forgetting/LLaMA-Factory-main/data_qa/wikiqa/wikiqa_test_qwen.json", "r", encoding="utf-8") as f:
    data = json.load(f)
